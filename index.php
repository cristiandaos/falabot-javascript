		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">30 DÍAS DE GARANTÍA DE DEVOLUCIÓN DE DINERO.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">ENVÍO GRATIS EN PEDIDOS SUPERIORES A S/. 100.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">TODOS LOS ARTÍCULOS AL MEJOR PRECIO</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
?>
	...
	<div class="product">		
		...
		<?php if($row['productAvailability']=='Disponible'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Agregar al carro</a></div>
				<?php } else {?>
    ...
    <div class="chatbot">
        ...
        <ul class="chatbox">
            <li class="chat incoming">
                ...
                <p>Hola, soy Falabot 👋🏼🤖! <br> ¿Cómo puedo ayudarte?</p>
            </li>
        </ul>
