...
if(isset($_POST['submit'])){
		...
		foreach($_POST['quantity'] as $key => $val){
			...
			echo "<script>alert('Tu carrito a sido actualizado');</script>";
		}
	}
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		if($query)
		{
echo "<script>alert('Dirección de envío a sido actualizada');</script>";
		}
	}
					...
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								...
								<input type="submit" name="submit" value="Actualizar carro de compras" class="btn btn-upper btn-primary pull-right outer-right-xs">
							</span>
...
<div class="form-group">
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Provincia<span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Distrito <span>*</span></label>
...
<div class="form-group">
					    <label class="info-title" for="Shipping Address">Dirección<span>*</span></label>
...
<div class="col-md-4 col-sm-12 cart-shopping-total">
	...
	<?php } else {
echo "Tu carro de compras está vacio";
		}?>
</div>			</div>
		</div> 
		</form>
