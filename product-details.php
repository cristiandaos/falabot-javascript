	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			$_SESSION['cart'][$row_p['id']]=array("quantity" => 1, "price" => $row_p['productPrice']);
					echo "<script>alert('El producto a sido agregado al carrito')</script>";
		echo "<script type='text/javascript'> document.location ='my-cart.php'; </script>";
		}else{
			$message="Product ID is invalido";
		}
	}
}
$pid=intval($_GET['pid']);
...
echo "<script>alert('El producto a sido agregado a la lista de deseos');</script>";
...
?>
					...
					<div class="products">
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">Agregar al carro</button></a>
								<?php } else {?>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='Disponible'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Agregar al carro</a>
													<?php } else {?>
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											<h4 class="title">Reseñas de los usuarios</h4>
			...
			<div class="product-price">	
				...
				<div class="action">
					<ul class="list-unstyled">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rw['id']; ?>" class="lnk btn btn-primary">Agregar al carro</a>
